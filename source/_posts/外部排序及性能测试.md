...
1. 首先要考虑的是待排序文件要怎么得到，我选择了用随机数随机产生数据得到数据文件，源码很简单如下：		
   ...
   ![demo](https://hx-w.github.io/img/extsort/post-inf-random.jpg "random_creater演示")

   检查生成文件大小：

   ![demo](https://hx-w.github.io/img/extsort/post-inf-random-check.jpg "random_creater-check演示")
...
2. 其次就是怎么检查文件是否排序完成。由于所有记录以二进制方式存入，用文本编辑器打开会显示乱码，且记录条数达到$512\times8N$，所以需要用程序辅助检查。
   ...
   ![demo](https://hx-w.github.io/img/extsort/post-inf-check.png "check_sorted演示")
...
![流程图](https://hx-w.github.io/img/extsort/post-inf-path.jpg "流程展示")
...
![算法框架](https://hx-w.github.io/img/extsort/post-inf-rs.jpg "算法框架")
...
![单点测试_1](https://hx-w.github.io/img/extsort/post-inf-init.png)

![单点测试_2](https://hx-w.github.io//img/extsort/post-inf-test.png)

最后我们用EXCEL打开`STAT.csv`文件，得到：

![结果](https://hx-w.github.io/img/extsort/post-inf-result.png "结果")
...
![结果](https://hx-w.github.io/img/extsort/post-inf-res.png "测试结果")
...
- 顺串个数随N的变化趋势
  ...
  ![顺串](https://hx-w.github.io/img/extsort/1_1859_run.png "顺串趋势")
...
- 建立顺串耗时、归并顺串耗时、总耗时随N的变化趋势
  ...
  ![耗时](https://hx-w.github.io/img/extsort/1_1859_cost.png "耗时趋势")

  可以很明显的看出在$N>1000$之后各项耗时变得很不稳定，而且显然建立顺串的过程比归并顺串的过程要稳定得多，可能是每组数据测的次数太少导致的。

- 各指标方差随N的变化趋势

  ![方差](https://hx-w.github.io/img/extsort/1_1859_var.png "方差趋势")
...
- 建立顺串耗时、归并顺串耗时、总耗时随N的变化趋势
  ...
  ![耗时](https://hx-w.github.io/img/extsort/1_547_cost.png "耗时趋势")

  总体上耗时和N的大小是正相关的，不过也N在250到300范围内的耗时出现了明显的断层，这个原因有很多，最有可能的是不同测试环境下的差异造成的，因为我把这些数据分成了很多个数据段分别发给同学们去测试。

- 各指标方差随N的变化趋势

  ![耗时](https://hx-w.github.io/img/extsort/1_547_var.png "方差趋势")
...
- *Joke-Lin* ([Github](https://github.com/Joke-Lin))
- *Marikruz*([Github](https://github.com/Marikruz))
- *KIIIKIII*([Github](https://github.com/KIIIKIII))
